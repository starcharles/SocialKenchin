...
app.controller('mainCtrl', function($scope,$http) {
  ...
  $scope.search = function(categoryId) {
    var url = 'https://app.rakuten.co.jp/services/api/Recipe/CategoryRanking/20121121?format=json&applicationId=1054051489365235823';
    url = url + '&categoryId=' + categoryId;
    console.log(categoryId);
    console.log(url);
    $http.get(url).
    success(function(data, status, headers, config) {
      $scope.menues=data.result;
  ...
  // var params = {
  //   applicationId: '1054051489365235823',
  //   categoryId: categoryId
  // };
  //
  // ranking.get(params, function(err, res) {
  //   console.log(res);
  //   // var menues = res.result.large;
  // });
